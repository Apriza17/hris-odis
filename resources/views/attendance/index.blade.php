            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="md:col-span-1">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 text-center">
                        ...
                        <div class="text-4xl font-bold text-gray-900 dark:text-white mb-8 tracking-widest" id="realtime-clock">
                            --:--:--
                        </div>
                        ...
                        <form action="{{ route('attendance.store') }}" method="POST">
                            ...
                            @if(!$attendance)
                                <button type="submit" class="w-48 h-48 rounded-full bg-blue-600 hover:bg-blue-700 text-white font-bold text-xl shadow-lg hover:shadow-xl transition-all transform hover:scale-105 flex flex-col items-center justify-center gap-2 border-4 border-blue-200 dark:border-blue-900">
                            ...
                            @elseif(!$attendance->time_out)
                                ...
                                <button type="submit" class="w-48 h-48 rounded-full bg-red-600 hover:bg-red-700 text-white font-bold text-xl shadow-lg hover:shadow-xl transition-all transform hover:scale-105 flex flex-col items-center justify-center gap-2 border-4 border-red-200 dark:border-red-900">
                            ...
                            @else
                                <div class="flex flex-col items-center justify-center h-48 bg-gray-50 dark:bg-gray-700 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600">
                ...
                <div class="md:col-span-2">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <h3 class="text-lg font-bold text-gray-800 dark:text-white mb-4">Riwayat Kehadiran Bulan Ini</h3>
                        ...
                        <div class="relative overflow-x-auto">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4">
                                            @if($item->status == 'present')
                                                <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded">Hadir</span>
                                            @elseif($item->status == 'late')
                                                <span class="bg-yellow-100 text-yellow-800 text-xs font-medium px-2.5 py-0.5 rounded">Telat</span>
                                            @else
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-4 text-center">Belum ada data absensi bulan ini.</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
