    ...
    <div class="px-3 py-3 lg:px-5">
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start rtl:justify-end">
          ...
          <a href="{{ route('dashboard') }}" class="flex ms-2 md:ms-4">
            <span class="self-center text-xl font-bold sm:text-2xl whitespace-nowrap dark:text-white">Orca<span class="text-blue-600">HRIS</span></span>
          </a>
        </div>
