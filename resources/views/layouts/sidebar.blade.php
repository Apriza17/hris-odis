<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            @if (Auth::user()->role === 'admin' || Auth::user()->role === 'super_admin')
                ...
                <li>
                    <a href="{{ route('payroll-components.index') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Komponen Gaji</span>
                    </a>
                </li>
                <li>
            ...
            @if (Auth::user()->role === 'admin' || Auth::user()->role === 'super_admin')
                <li class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                    <span class="px-2 text-xs font-semibold text-gray-500 uppercase">Lainnya</span>
                </li>
                ...
                <li>
                    <a href="{{ route('company.edit') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Pengaturan Kantor</span>
                    </a>
                </li>
            @endif
        </ul>
