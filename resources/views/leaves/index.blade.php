                            ...
                            <tr
                                ...
                                <td class="px-6 py-4">
                                    @if ($leave->type == 'annual')
                                        <span
                                            class="bg-purple-100 text-purple-800 text-xs font-medium px-2.5 py-0.5 rounded">Cuti
                                            Tahunan</span>
                                    @elseif($leave->type == 'sick')
                                        <span
                                            class="bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded">Sakit</span>
                                    @else
                                        <span
                                            class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded">Izin</span>
                                    @endif
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    @if ($leave->status == 'approved')
                                        <span
                                            class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded border border-green-400">Disetujui</span>
                                    @elseif($leave->status == 'rejected')
                                        <span
                                            class="bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded border border-red-400">Ditolak</span>
                                    @else
                                        <span
                                            class="bg-yellow-100 text-yellow-800 text-xs font-medium px-2.5 py-0.5 rounded border border-yellow-400">Menunggu</span>
                                    @endif
                                </td>
